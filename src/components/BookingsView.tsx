  ...
  return (
    <div id="view-bookings" className="p-8 sm:p-10 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
                  ...
                  <div className="bg-white rounded-2xl border border-slate-200/90 p-6 shadow-xs space-y-4">
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          id="btn-whatsapp-dispatch-open"
                          onClick={() => setShowWhatsAppModal(true)}
                          className="px-5 py-2.5 rounded-xl text-xs font-bold bg-[#25D366] hover:bg-[#20bd5c] text-white transition-all shadow-sm flex items-center gap-2"
                        >
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <path d="M12 0C5.373 0 0 5.373 0 12c0 2.118.55 4.106 1.515 5.83L0 24l6.335-1.493A11.954 11.954 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.368l-.36-.213-3.727.878.893-3.627-.234-.373A9.818 9.818 0 1112 21.818z"/>
                          </svg>
      ...
      <WhatsAppDispatchModal
        ...
        eventName={activeBooking.name}
        eventDate={activeBooking.date}
        eventTime={`${activeBooking.startTime} – ${activeBooking.endTime}`}
        eventLocation={activeBooking.venue}
        workers={[
          { id: 'wc-1', name: 'Siti Nurhaliza', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', phone: '+60 12-234 5678', role: 'Senior Event Coordinator', confirmed: true },
          { id: 'wc-2', name: 'Ahmad Faiz', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80', phone: '+60 11-876 5432', role: 'AV Technician', confirmed: true },
          { id: 'wc-3', name: 'Michelle Lee', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80', phone: '+60 16-112 3344', role: 'VIP Host & Protocol Lead', confirmed: true },
          { id: 'wc-4', name: 'Kamal Hassan', avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80', phone: '+60 17-554 9900', role: 'Usher & Registration Crew', confirmed: false },
        ]}
      />
